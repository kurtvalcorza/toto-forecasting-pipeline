...
EXPECTED_OUTPUTS = ('outputs/toto_forecast.csv', 'outputs/toto_provenance.json')
...
CODE_MARKERS = (
    ...
    'from toto_forecasting_pipeline import TotoForecastPipeline, last_value_baseline, mae, rmse,',
    'interval_coverage, MODEL_ID, MODEL_REVISION',
